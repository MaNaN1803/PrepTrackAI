...
export default function Page() {
  return (
    <section className="bg-white dark:bg-gray-900 min-h-screen flex items-center justify-center">
      <div className="flex flex-col lg:flex-row items-center justify-center w-full max-w-6xl px-8 py-8 sm:px-12 lg:px-16 lg:py-12">
        {/* Text Section */}
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center">
          {/* Wrapper to resize the form */}
          <div className="w-full max-w-sm p-4 transform scale-90 lg:scale-80">
            <SignUp />
          </div>
        </div>
      </div>
