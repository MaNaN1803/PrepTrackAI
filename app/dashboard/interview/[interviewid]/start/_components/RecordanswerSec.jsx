  ...
  const updateuseranswerindb = async () => {
    try {
      ...
      const feedbackprompt = `{
        ...
        "request": "Please auto-correct any spelling or word misinterpretations and also accept multilingual answers , The answer could be in Hindi or English. If it's in Hindi, translate it to English and also do not provide hindi review or feedback provide only in english and finally Provide a performance rating (out of 10), feedback, areas of improvement, correct answer, and language tone assessment in JSON format with 'rating', 'feedback', 'userAnswer', 'date', and 'correctAnswer' fields."
      }`;
